...
This is the classic implmentation for calculating Pagerank, seen in algorithm~\ref{alg:toppgrnk} . It is straight forward, but recalculates all X values every iteration. This could be redundant on a large percentage of the X indices, and therefore, it could waste computational power. 
